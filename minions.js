...
async function minions(args) {
    ...
    let minions = YAML.parse(fs.readFileSync('./dat/minions.yaml', 'utf8'), { prettyErrors: true });
    let prices = YAML.parse(fs.readFileSync('./dat/prices.yaml', 'utf8'), { prettyErrors: true });
