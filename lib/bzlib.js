...
async function writeBazaarItemsCache() {
    ...
    for (let itemName of _.keys(bazaarItems.products)) {
        ...
        items[itemNameLowerCase] = {
            ...
            cost: Math.round(100 * item.sellPrice) / 100,
            sell: Math.round(100 * item.buyPrice) / 100,
